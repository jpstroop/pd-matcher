...
Reflects the upstream-data boundary: the CCE itself ends 31 Dec 1977 (last
day of 1909-Act registrations per Copyright Office Circular 23), so anything
published after that point has no CCE registration to link to and is out of
scope for this matcher.
"""
